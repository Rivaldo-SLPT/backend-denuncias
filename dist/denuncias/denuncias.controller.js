...
const create_denuncia_dto_1 = require("./dto/create-denuncia.dto");
...
let DenunciasController = class DenunciasController {
    ...
    updateStatus(id, updateStatusDto, req) {
        if (req.user.role !== 'authority') {
            throw new common_1.UnauthorizedException('Only authority can update status');
        }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], DenunciasController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
